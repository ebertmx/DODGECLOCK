...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SDC_SLAVE_COUNT, 5);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_DCLK32, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MIN_INT, 400);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MAX_INT, 400);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_SLAVE_LATENCY, 2);
